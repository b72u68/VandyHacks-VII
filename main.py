...
def parse_args():
    ...
    parser.add_argument('-bw', '--badwords', help='(Monitoring mode) Include file contains inappropriate words', default='./badWords.txt')
    parser.add_argument('-fw', '--filterwords', help='(Monitoring mode) Include file contains words to filter messages', default='./filterWords.txt')
